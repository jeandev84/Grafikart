...
class AdminPropertyController extends AbstractController
{
     ...
     * @param Request $request
     * @param CacheManager $cacheManager [ situe dans le Liip bundle ]
     * @param UploaderHelper $helper [ situe dans Vich bundle ]
     * @return \Symfony\Component\HttpFoundation\Response
    ...
    public function edit(Property $property, Request $request, CacheManager $cacheManager, UploaderHelper $helper)
    {
        ...
        */
        ...
        if($form->isSubmitted() && $form->isValid())
        {
            # On verifie s'il y a eu fichier uploade
            if($property->getImageFile() instanceof UploadedFile)
            {
                # supprimer un fichier qui a ete mis en cache par liip
                # chemin de l'image $helper->asset($property, 'imageFile')
